...
class Thermostat(HomeAccessory):
    ...
    def _handle_target_heating_cooling(self, char_values, params, events, state):
    ...
    def _handle_target_temperature(self, char_values, features, params, events, homekit_hvac_mode):
    ...
    def _handle_threshold_temperatures(self, char_values, params, events):
    ...
    def _set_chars(self, char_values):
        ...
        if (
            ...
            self._handle_target_heating_cooling(char_values, params, events, state)

        if CHAR_TARGET_TEMPERATURE in char_values:
            self._handle_target_temperature(char_values, features, params, events, homekit_hvac_mode)
        ...
        if (
            ...
            service = SERVICE_SET_TEMPERATURE_THERMOSTAT
            self._handle_threshold_temperatures(char_values, params, events)
